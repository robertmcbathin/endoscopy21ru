    ...
    <nav class="navbar navbar-toggleable-md bg-primary fixed-top " color-on-scroll="500">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="../assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="template.html#pablo">
                            <p>Link</p>
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link twitter-sharrre-nav" rel="tooltip" title="Tweet" data-placement="bottom" href="template.html#pablo">
                            <i class="fa fa-twitter"></i>
                            <p class="hidden-lg-up">Twitter</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link facebook-sharrre-nav" rel="tooltip" title="Share" data-placement="bottom" href="template.html#pablo">
                            <i class="fa fa-facebook-square"></i>
                            <p class="hidden-lg-up">Facebook</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link linkedin-sharrre-nav" rel="tooltip" title="Share" data-placement="bottom" href="template.html#pablo">
